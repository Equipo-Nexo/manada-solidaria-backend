...
class AnimalPostRepositoryTest {
    ...
    private void persistLostPost(String title, StatusLostPost currentStatus) {
        ...
        // Reemplaza el CREATED seeded por el constructor para simular un post en el estado pedido.
        post.setStatusHistory(new ArrayList<>(List.of(new LostPostStatusHistory(currentStatus, post))));
    ...
    private void persistAdoptionPost(String title, StatusAdoptionPost currentStatus) {
        ...
        // Reemplaza el CREATED seeded por el constructor para simular un post en el estado pedido.
        post.setStatusHistory(new ArrayList<>(List.of(new AdoptionPostStatusHistory(currentStatus, post))));
        animalPostRepository.save(post);
    }
