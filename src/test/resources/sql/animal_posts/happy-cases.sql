...
MERGE INTO PROFILE (ID, PROFILE_IMAGEURL) KEY (ID)
VALUES ('aa000000-0000-0000-0000-000000000001', 'cf-perfil-rescatista');

MERGE INTO PROFILE_ROLES (PROFILE_ID, ROLE) KEY (PROFILE_ID, ROLE)
VALUES ('aa000000-0000-0000-0000-000000000001', 'RESCUER');
...
-- Dueño sin RESCUER
MERGE INTO PROFILE (ID, PROFILE_IMAGEURL) KEY (ID)
VALUES ('aa000000-0000-0000-0000-000000000002', 'cf-perfil-vecino');

MERGE INTO PROFILE_ROLES (PROFILE_ID, ROLE) KEY (PROFILE_ID, ROLE)
VALUES ('aa000000-0000-0000-0000-000000000002', 'COMMUNITY');
